...
**CRITICAL**: This agent receives knowledge findings from compass-knowledge-discovery as input - it does not make strategic decisions in a knowledge vacuum.
...
```json
{
  ...
  "agent_assignments": {
    "knowledge_query": "compass-knowledge-discovery",
  ...
  "sequential_phases": [
    "compass-knowledge-discovery MUST complete first",
  ...
  "docs_first_compliance": "compass-knowledge-discovery scheduled first in all cases"
}
```
...
**Agents**: compass-knowledge-discovery (ALREADY COMPLETED), minimal additional agents as needed
...
**CRITICAL**: compass-knowledge-discovery has been completed by captain before this strategic planning
...
**Agents**: compass-knowledge-discovery (ALREADY COMPLETED), compass-pattern-apply, compass-coder
...
**Agents**: compass-knowledge-discovery (ALREADY COMPLETED), All 6-phase COMPASS agents as needed
...
- **compass-knowledge-discovery**: Existing docs/ and maps/ search (COMPLETED BY CAPTAIN)
...
1. **DOCS-FIRST ABSOLUTE**: compass-knowledge-discovery is MANDATORY FIRST in ALL plans - no exceptions
...
### compass-knowledge-discovery COMPLETED BEFORE STRATEGIC PLANNING
- **CAPTAIN RESPONSIBILITY**: compass-knowledge-discovery has been completed by compass-captain before this agent is called
...
### Input Requirements
- **Knowledge Findings**: Captain must provide compass-knowledge-discovery results as input
...
- compass-knowledge-discovery results from captain
